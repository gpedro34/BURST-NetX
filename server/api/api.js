...
defaults.logger.info = process.env.LOG_INFO || defaults.logger.info;
defaults.logger.name = process.env.LOG_NAME || defaults.logger.name;
defaults.logger.reqHeaders =
	process.env.LOG_REQ_HEAD || defaults.logger.reqHeaders;
defaults.logger.resHeaders =
	process.env.LOG_RES_HEAD || defaults.logger.resHeaders;
